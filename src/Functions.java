...
//            case MINER_FULL:
//                action.world.executeMinerFullActivity(action.entity,
//                                         action.imageStore, scheduler);
//                break;
//
//            case MINER_NOT_FULL:
//                action.world.executeMinerNotFullActivity(action.entity,
//                                            action.imageStore, scheduler);
//                break;
//
//            case ORE:
...
//
//            case VEIN:
//                action.world.executeVeinActivity(action.entity,
//                                    action.imageStore, scheduler);
//                break;
//
//            default:
